...
export const Links = [
  {
    name: 'Orders',
    icon: <TbTruckDelivery size={25} className='mr-4 text-orange-500' />,
  },
  {
    name: 'Favorites',
    icon: <MdFavorite size={25} className='mr-4 text-orange-500' />,
  },
  {
    name: 'Wallet',
    icon: <FaWallet size={25} className='mr-4 text-orange-500' />,
  },
  {
    name: 'Help',
    icon: <MdHelp size={25} className='mr-4 text-orange-500' />,
  },
  {
    name: 'Promotions',
    icon: <AiFillTag size={25} className='mr-4 text-orange-500' />,
  },
  {
    name: 'Best Ones',
    icon: <BsFillSaveFill size={25} className='mr-4 text-orange-500' />,
  },
  {
    name: 'Invite Friends',
