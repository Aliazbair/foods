...
function App() {
  console.log(Links);
  return (
    <div className='bg-gray-900s'>
      <Navbar />

      {/* //TODO this well convert to component */}
      <div className='flex items-center justify-center flex-wrap  py-32 gap-4 mx-auto px-10 max-w-7xl '>
        {Links.map(({ name, icon }) => (
          <div
            key={name}
      ...
      {/* //todo this well convert to component */}
      <div className='grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 mx-auto px-10 max-w-7xl justify-center items-center'>
